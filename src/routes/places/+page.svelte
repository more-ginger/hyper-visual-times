    ...
    <div id="places-essay">
        ...
        <section id="scrolly-1" class=" md:flex">
            ...
            <article class="w-full z-10 ml-4 relative md:basis-1/3">
                <div data-step="5" class="step p-6 table" style="min-height:600px">
                    <div class="align-middle table-cell">
                ...
                <div data-step="6" class="step px-4 table" style="height:200px">
                ...
                <div data-step="7" class="step px-4" style="height:200px">
                ...
                <div data-step="8" class="step px-4" style="height:200px">
                ...
                <div data-step="9" class="step px-4" style="height:200px">
