...
<div class="base m-auto w-11/12 pt-20">
	<div id="places-essay">
		...
		<section id="scrolly-2" class="md:flex md:flex-row-reverse">
			...
			<article class="relative w-full md:basis-1/3">
				<div data-step="0" class="step p-6">
					<div class="table-cell align-middle">
						...
						<p class="mb-2">
							...
							newspaper's own country. The rest of this coverage is split across other countries, as
							shown on the left. The frequency at which certain geo-political entities are referred
							to translates into relevance for the reader. This relevance is constructed by
							following certain patterns. For example, these keywords are set at different
							granularities. At a low level we have names of cities, like Berlin or New York,
							sometimes even names of neighborhoods, like Manhattan (NY). At a higher level, we have
							names of states (Baden-Wuttemberg, Ohio), countries (Bolivia, Italien, Greenland), and
							supra-national geo-political or geographical entities (Red Sea, Atlantic Ocean). If we
							reduce the granularity by aggregating all localities with their country and assign
							each region and country to macro-regions, we can observe how newspapers have different
							areas of interest.
							<img
						...
						<p>
							...
							“split” into areas of interest based on how much either Die Zeit or The New York Times
							cover a specific country.
						</p>
					</div>
				</div>
				...
				<div data-step="2" class="step p-6" style="height:900px">
					<div class="table-cell align-middle">
						For the New York Times, half of the coverage is tagged with geo-political keywords about
						the two regions of Asia and Middle East. At first, this delineates a largely
						conflict-first approach, with the Israel-Palestine conflict as central. However, it also
						brings forward a much broader concern of the newspaper for foreign affairs, especially
						if compared with Zeit.
					</div>
				</div>
				<div data-step="3" class="step p-6" style="height:900px">
					<div class="table-cell align-middle">
						The NYT also provides tags about geographical entities that are not directly associated
						with countries, like natural landmarks or geographically distinct areas encompassing
						several countries (seas, deserts, etc.). This shows a different, possibly more granular,
						strategy in producing and tagging content.
					</div>
				</div>
				<div data-step="4" class="step p-6" style="height:900px">
					<div class="table-cell align-middle">
						...
						reciprocal attention. Content tagged with keywords related to the United States takes up
						almost 20% of Zeit news, whereas for the NYT the direct reference to Germany is much
						less central.
					</div>
				</div>
		...
		<section id="scrolly-1" class=" md:flex">
			...
			<article class="relative z-10 ml-4 w-full md:basis-1/3">
				<div data-step="7" class="step table px-4" style="height:600px">
					<div class="table-cell align-top">
						...
						<p>
							...
							The meta-keywords for Israel, Palestine (Gaza), Russia, China, Ukraine, United
							Kingdom, France, Iran, Lebanon and Europe are in the top 10 of the New York Times.
						</p>
					</div>
				</div>
				<div data-step="8" class="step p-6 px-4" style="height:600px">
					...
					referenced country. Then, Palestine is seldom referenced – outside of the top 20. China is
					also less referenced than in NYT coverage.
				</div>
				...
				<div data-step="10" class="step p-6 px-4" style="height:600px">
					From the Zeit perspective, relevant keywords relate to countries mostly part of the EU or
					with a direct shared border with Germany. Exceptions are Turkey (close to Germany for
